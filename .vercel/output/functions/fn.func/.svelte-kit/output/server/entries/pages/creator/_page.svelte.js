      ...
      default: () => {
        return `${each(work_exps, (work, i) => {
          return `${validate_component(FormTemplate, "FormTemplate").$$render(
            ...
            {
              default: () => {
                return `<div class="lg:grid grid-rows-4 grid-cols-2 gap-4"><div class="col-span-2"><label for="company-name" class="label"><span class="label-text">Company Name</span></label>                        <input type="text" id="company-name" name="company-name" class="input input-bordered w-full "${add_attribute("value", work.company_name, 0)}></div>
                    ...
                    <div><label for="start_date" class="label"><span class="label-text">Start Date Date</span></label>                          <input type="text" id="start_date" name="start_date" class="input input-bordered w-full max-w-xs"${add_attribute("value", work.start_date, 0)}></div>
                    <div><label for="end_date" class="label"><span class="label-text">End Date</span></label>                          <input type="text" id="end_date" name="end_date" class="input input-bordered w-full max-w-xs"${add_attribute("value", work.end_date, 0)}></div>
                    <div class="col-span-2"><label for="Description" class="label"><span class="label-text">Description</span></label>                          <textarea id="description" name="description" class="input input-bordered w-full">${work.description || ""}</textarea>
                    </div></div>
            `;
              }
            }
            ...
            <button class="btn btn-outline w-full mt-5 border-dashed">Add Experience </button>`;
      }
    })}
...
const preview_backup_svelte_svelte_type_style_lang = "";
  ...
  return `<body><div class="drawer drawer-mobile"><input id="my-drawer-2" type="checkbox" class="drawer-toggle">
        <div class="drawer-content flex flex-col items-center justify-center">
            <div class="container svelte-14gq38b"><div class="editor svelte-14gq38b">${validate_component(Input, "Input").$$render($$result, {}, {}, {})}</div>
                ...
                <div class="output svelte-14gq38b">${validate_component(Preview, "PreviewCopy").$$render($$result, {}, {}, {})}</div></div></div>
